			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li><a href="viewacinfo.jsp" class="scroll">View Accounts Information</a></li>
						<li><a href="traamt.jsp" class="scroll">Transfer Amount</a></li>
						<li><a href="treport.jsp" class="scroll">Transaction Report</a></li>
